...
- Категории статусов Jira предполагаются стандартными английскими названиями («To Do»/«In Progress»/«Done») — на локализованном Jira-сайте с переведёнными категориями сопоставление `statusCategoryByName` может не сработать корректно.
